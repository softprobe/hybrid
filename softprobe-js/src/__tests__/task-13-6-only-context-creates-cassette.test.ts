 ...
 * No new CaseJsonFileCassette in init, middleware, request-storage, or replay helpers.
 */
...
describe('Task 13.6: only SoftprobeContext creates cassette instances', () => {
  it('forbidden production files do not instantiate CaseJsonFileCassette', () => {
    const violations: string[] = [];
    const pattern = /new\s+CaseJsonFileCassette\s*\(/;
  ...
  it('replay helper workers do not instantiate CaseJsonFileCassette', () => {
    const replayWorkers = [
