...
**Configuration:** Mode and cassette directory come from **YAML config only**. Do not use `SOFTPROBE_CASSETTE_PATH` or `SOFTPROBE_CASSETTE_DIRECTORY`. The app reads `./.softprobe/config.yml` by default, or the path in `SOFTPROBE_CONFIG_PATH`.
...
See the main [Softprobe README](../../README.md), [design.md](../../design.md), [design-proxy-first.md](../../design-proxy-first.md), [design-multi-repo-layout.md](../../design-multi-repo-layout.md), [design-context.md](../../design-context.md), [design-cassette.md](../../design-cassette.md), and [design-matcher.md](../../design-matcher.md) for more.
