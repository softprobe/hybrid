...
|---|---|---|---|
| `name` | string | no | Optional human-readable label (logs, suite mocks). Omitted from payloads when unused. |
| `priority` | integer | no | Higher wins on conflict. Default: `0` if omitted. |
